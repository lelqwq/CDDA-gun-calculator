...
void load_generated_gunmods()
{
    ...
    // 字段顺序：id, name, name_en, location, handling_modifier, dispersion_modifier, aim_speed_modifier, sight_dispersion, field_of_view, weight_g, volume_ml, bipod, laser_sight, zoom, ammo_modifier, mod_targets, add_mod, source
    ...
    add_gunmod("grip_mount", "可更换枪具套装", "replaceable furniture kit", "grip mount", 0, 0, 0, -1, -1, 80, 50, false, false, false, {}, {"smg", "rifle", "pistol", "shotgun", "crossbow", "launcher"}, {"grip"}, "core");
    ...
    add_gunmod("holo_sight", "全息瞄准镜", "holographic sight", "sights", 0, 0, 10, 23, 720, 255, 290, false, false, false, {}, {"smg", "rifle", "shotgun", "crossbow", "launcher"}, {"magnifier"}, "core");
    add_gunmod("hybrid_sight_4x", "混合式 ACOG 瞄准镜", "hybrid ACOG scope", "sights", 0, 0, 0, 8, 270, 280, 112, false, false, true, {}, {"rifle", "crossbow", "launcher", "shotgun", "smg"}, {"sights"}, "core");
    ...
    add_gunmod("offset_sight_rail", "侧面瞄具导轨", "offset sight rail", "rail", 0, 0, 0, -1, -1, 40, 125, false, false, false, {}, {"shotgun", "smg", "rifle", "launcher"}, {"sights"}, "core");
    ...
    add_gunmod("rail_bayonet_lug", "导轨刺刀底座", "rail bayonet mount", "rail", 0, 0, 0, -1, -1, 162, 40, false, false, false, {}, {"smg", "rifle", "pistol", "shotgun", "crossbow", "launcher"}, {"bayonet lug"}, "core");
    ...
    add_gunmod("rail_mount", "导轨底座", "side mount", "rail mount", 0, 0, 0, -1, -1, 10, 8, false, false, false, {}, {"smg", "rifle", "pistol", "shotgun", "crossbow", "launcher"}, {"rail"}, "core");
    ...
    add_gunmod("retool_ar15_22", ".22 上机匣", ".22 upper receiver", "bore", 0, 15, 0, -1, -1, 2275, 1696, false, false, false, {"22"}, {"modular_ar15", "modular_m4_carbine", "modular_m16a4", "modular_m16_auto_rifle", "modular_m27_assault_rifle", "modular_ar_pistol"}, {"brass catcher", "bayonet lug", "rail", "sights", "underbarrel", "muzzle"}, "core");
    add_gunmod("retool_ar15_223rem", ".223 中长上机匣", "mid-length .223 upper receiver", "bore", 0, 0, 0, -1, -1, 2268, 1550, false, false, false, {"223"}, {"modular_ar15", "modular_m4_carbine", "modular_m16a4", "modular_m16_auto_rifle", "modular_m27_assault_rifle", "modular_ar_pistol"}, {"brass catcher", "bayonet lug", "rail", "sights", "underbarrel", "muzzle"}, "core");
    add_gunmod("retool_ar15_223rem_extended", ".223 长管上机匣", "rifle .223 upper receiver", "bore", 0, 0, 0, -1, -1, 2408, 1860, false, false, false, {"223"}, {"modular_ar15", "modular_m4_carbine", "modular_m16a4", "modular_m16_auto_rifle", "modular_m27_assault_rifle", "modular_ar_pistol"}, {"brass catcher", "bayonet lug", "rail", "sights", "underbarrel", "muzzle"}, "core");
    add_gunmod("retool_ar15_223rem_medium", ".223 卡宾上机匣", "carbine .223 upper receiver", "bore", 0, 0, 0, -1, -1, 2036, 1395, false, false, false, {"223"}, {"modular_ar15", "modular_m4_carbine", "modular_m16a4", "modular_m16_auto_rifle", "modular_m27_assault_rifle", "modular_ar_pistol"}, {"brass catcher", "bayonet lug", "rail", "sights", "underbarrel", "muzzle"}, "core");
    add_gunmod("retool_ar15_223rem_pistol", ".223 手枪上机匣", "pistol .223 upper receiver", "bore", 0, 0, 0, -1, -1, 1134, 718, false, false, false, {"223"}, {"modular_ar15", "modular_m4_carbine", "modular_m16a4", "modular_m16_auto_rifle", "modular_m27_assault_rifle", "modular_ar_pistol"}, {"brass catcher", "rail", "sights", "underbarrel", "muzzle"}, "core");
    add_gunmod("retool_ar15_223rem_short", ".223 CQB上机匣", "CQB .223 upper receiver", "bore", 0, 0, 0, -1, -1, 1819, 1295, false, false, false, {"223"}, {"modular_ar15", "modular_m4_carbine", "modular_m16a4", "modular_m16_auto_rifle", "modular_m27_assault_rifle", "modular_ar_pistol"}, {"brass catcher", "rail", "sights", "underbarrel", "muzzle"}, "core");
    add_gunmod("retool_ar15_300blk", ".300 BLK 中长上机匣", "mid-length .300BLK upper receiver", "bore", 0, 0, 0, -1, -1, 2308, 1550, false, false, false, {"300blk"}, {"modular_ar15", "modular_m4_carbine", "modular_m16a4", "modular_m16_auto_rifle", "modular_m27_assault_rifle", "modular_ar_pistol"}, {"brass catcher", "bayonet lug", "rail", "sights", "underbarrel", "muzzle"}, "core");
    add_gunmod("retool_ar15_300blk_medium", ".300 BLK CQB上机匣", "CQB .300BLK upper receiver", "bore", 0, 0, 0, -1, -1, 1814, 1295, false, false, false, {"300blk"}, {"modular_ar15", "modular_m4_carbine", "modular_m16a4", "modular_m16_auto_rifle", "modular_m27_assault_rifle", "modular_ar_pistol"}, {"brass catcher", "bayonet lug", "rail", "sights", "underbarrel", "muzzle"}, "core");
    add_gunmod("retool_ar15_300blk_short", ".300 BLK 短管上机匣", "SBR .300BLK upper receiver", "bore", 0, 0, 0, -1, -1, 1590, 1550, false, false, false, {"300blk"}, {"modular_ar15", "modular_m4_carbine", "modular_m16a4", "modular_m16_auto_rifle", "modular_m27_assault_rifle", "modular_ar_pistol"}, {"brass catcher", "rail", "sights", "underbarrel", "muzzle"}, "core");
    add_gunmod("retool_ar15_450", ".450 长管上机匣", "rifle .450 upper receiver", "bore", 0, 15, 0, -1, -1, 2722, 1760, false, false, false, {"450"}, {"modular_ar15", "modular_m4_carbine", "modular_m16a4", "modular_m16_auto_rifle", "modular_m27_assault_rifle", "modular_ar_pistol"}, {"brass catcher", "bayonet lug", "rail", "sights", "underbarrel", "muzzle"}, "core");
    add_gunmod("retool_ar15_450_medium", ".450 CQB上机匣", "CQB .450 upper receiver", "bore", 0, 15, 0, -1, -1, 1900, 1295, false, false, false, {"450"}, {"modular_ar15", "modular_m4_carbine", "modular_m16a4", "modular_m16_auto_rifle", "modular_m27_assault_rifle", "modular_ar_pistol"}, {"brass catcher", "bayonet lug", "rail", "sights", "underbarrel", "muzzle"}, "core");
    add_gunmod("retool_ar15_450_short", ".450 短管上机匣", "SBR .450 upper receiver", "bore", 0, 15, 0, -1, -1, 1615, 850, false, false, false, {"450"}, {"modular_ar15", "modular_m4_carbine", "modular_m16a4", "modular_m16_auto_rifle", "modular_m27_assault_rifle", "modular_ar_pistol"}, {"brass catcher", "rail", "sights", "underbarrel", "muzzle"}, "core");
    add_gunmod("retool_ar15_50beowulf", "12.7x42mm 长管上机匣", "rifle 12.7x42mm upper receiver", "bore", 0, 15, 0, -1, -1, 2495, 1760, false, false, false, {"50beowulf"}, {"modular_ar15", "modular_m4_carbine", "modular_m16a4", "modular_m16_auto_rifle", "modular_m27_assault_rifle", "modular_ar_pistol"}, {"brass catcher", "bayonet lug", "rail", "sights", "underbarrel", "muzzle"}, "core");
    add_gunmod("retool_ar15_50beowulf_medium", "12.7x42mm 中长上机匣", "mid-length 12.7x42mm upper receiver", "bore", 0, 15, 0, -1, -1, 2341, 1550, false, false, false, {"50beowulf"}, {"modular_ar15", "modular_m4_carbine", "modular_m16a4", "modular_m16_auto_rifle", "modular_m27_assault_rifle", "modular_ar_pistol"}, {"brass catcher", "bayonet lug", "rail", "sights", "underbarrel", "muzzle"}, "core");
    add_gunmod("retool_ar15_50beowulf_short", "12.7x42mm 短管上机匣", "SBR 12.7x42mm upper receiver", "bore", 0, 15, 0, -1, -1, 1615, 850, false, false, false, {"50beowulf"}, {"modular_ar15", "modular_m4_carbine", "modular_m16a4", "modular_m16_auto_rifle", "modular_m27_assault_rifle", "modular_ar_pistol"}, {"brass catcher", "rail", "sights", "underbarrel", "muzzle"}, "core");
    add_gunmod("retool_ar15_762", "7.62x39mm 上机匣", "7.62x39mm upper receiver", "bore", 0, 0, 0, -1, -1, 2268, 1550, false, false, false, {"762"}, {"modular_ar15", "modular_m4_carbine", "modular_m16a4", "modular_m16_auto_rifle", "modular_m27_assault_rifle", "modular_ar_pistol"}, {"brass catcher", "bayonet lug", "rail", "sights", "underbarrel", "muzzle"}, "core");
    add_gunmod("retool_axmc_300win", "AXMC .300 枪管套件", "AXMC .300 barrel-assembly", "bore", 0, 0, 0, -1, -1, 1000, 500, false, false, false, {"300"}, {"axmc"}, {"muzzle"}, "core");
    add_gunmod("retool_axmc_308win", "AXMC .308 枪管套件", "AXMC .308 barrel-assembly", "bore", 0, 0, 0, -1, -1, 1000, 500, false, false, false, {"308"}, {"axmc"}, {"muzzle"}, "core");
    add_gunmod("retool_axmc_338lapua", "AXMC .338 枪管套件", "AXMC .338 barrel-assembly", "bore", 0, 0, 0, -1, -1, 1000, 500, false, false, false, {"338lapua"}, {"axmc"}, {"muzzle"}, "core");
    add_gunmod("retool_cz600_223rem", "CZ .223 枪管套件", "CZ .223 barrel-assembly", "bore", 0, 0, 0, -1, -1, 1000, 500, false, false, false, {"223"}, {"cz600"}, {"muzzle"}, "core");
    add_gunmod("retool_cz600_762", "CZ 7.62x39mm 枪管套件", "CZ 7.62x39mm barrel-assembly", "bore", 0, 0, 0, -1, -1, 1000, 500, false, false, false, {"762"}, {"cz600"}, {"muzzle"}, "core");
    add_gunmod("retool_deagle_357", "沙漠之鹰 .357 改装套件", "Desert Eagle .357 conversion kit", "bore", 0, 0, 0, -1, -1, 498, 550, false, false, false, {"357mag"}, {"modular_deagle"}, {"sights"}, "core");
    add_gunmod("retool_deagle_44", "沙漠之鹰 .44 改装套件", "Desert Eagle .44 conversion kit", "bore", 4, 15, 0, -1, -1, 498, 550, false, false, false, {"44"}, {"modular_deagle"}, {"sights"}, "core");
    add_gunmod("retool_deagle_50", "沙漠之鹰 .50 改装套件", "Desert Eagle .50 conversion kit", "bore", 4, 15, 0, -1, -1, 498, 550, false, false, false, {"50ae"}, {"modular_deagle"}, {"sights"}, "core");
    add_gunmod("retool_mdrx_223rem", "MDRX .223 加长套件", "MDRX .223 extended-assembly", "bore", 4, 15, 0, -1, -1, 1000, 500, false, false, false, {"223"}, {"mdrx"}, {"muzzle"}, "core");
    add_gunmod("retool_mdrx_223rem_medium", "MDRX .223 标准套件", "MDRX .223 standard-assembly", "bore", 4, 15, 0, -1, -1, 840, 420, false, false, false, {"223"}, {"mdrx"}, {"muzzle"}, "core");
    add_gunmod("retool_mdrx_223rem_short", "MDRX .223 MICRON套件", "MDRX .223 MICRON assembly", "bore", 4, 15, 0, -1, -1, 680, 340, false, false, false, {"223"}, {"mdrx"}, {"muzzle"}, "core");
    add_gunmod("retool_mdrx_300blk", "MDRX .300 BLK 标准套件", "MDRX .300BLK standard-assembly", "bore", 4, 15, 0, -1, -1, 840, 420, false, false, false, {"300blk"}, {"mdrx"}, {"muzzle"}, "core");
    add_gunmod("retool_mdrx_308win", "MDRX .308 加长套件", "MDRX .308 extended-assembly", "bore", 4, 15, 0, -1, -1, 1000, 500, false, false, false, {"308"}, {"mdrx"}, {"muzzle"}, "core");
    add_gunmod("retool_mdrx_308win_medium", "MDRX .308 标准套件", "MDRX .308 standard-assembly", "bore", 4, 15, 0, -1, -1, 840, 420, false, false, false, {"308"}, {"mdrx"}, {"muzzle"}, "core");
    add_gunmod("retool_ump_40", "UMP .40 S&W 改装套件", "UMP .40 S&W conversion kit", "bore", 0, 0, 0, -1, -1, 1200, 700, false, false, false, {"40"}, {"modular_ump", "modular_ump_9", "modular_ump_40", "modular_ump_45"}, {"muzzle"}, "core");
    add_gunmod("retool_ump_45", "UMP .45 ACP 改装套件", "UMP .45 ACP conversion kit", "bore", 0, 0, 0, -1, -1, 1400, 700, false, false, false, {"45"}, {"modular_ump", "modular_ump_9", "modular_ump_40", "modular_ump_45"}, {"muzzle"}, "core");
    add_gunmod("retool_ump_9", "UMP 9x19mm 改装套件", "UMP 9x19mm conversion kit", "bore", 0, 0, 0, -1, -1, 1200, 700, false, false, false, {"9mm"}, {"modular_ump", "modular_ump_9", "modular_ump_40", "modular_ump_45"}, {"muzzle"}, "core");
    ...
    add_gunmod("rifle_scope_high_end_mount", "高端步枪瞄准镜", "high end rifle scope", "sights", 0, 0, -1, 0, 270, 700, 485, false, false, true, {}, {"rifle", "crossbow", "launcher", "shotgun"}, {"sights"}, "core");
    ...
    add_gunmod("robofac_gun_exodii", "HWP 异域型(12.3ln)", "HWP EXOTIC configuration", "bore", 18, 0, 0, -1, -1, 2400, 1200, true, false, false, {"123ln"}, {"robofac_gun"}, {"muzzle"}, "core");
    ...
    add_gunmod("sights_mount", "瞄具底座", "sights mount", "sights mount", 0, 0, 0, -1, -1, 10, 8, false, false, false, {}, {"smg", "rifle", "shotgun", "crossbow"}, {"sights"}, "core");
    add_gunmod("sights_mount_launcher", "发射器瞄具底座", "launcher sights mount", "sights mount", 0, 0, 0, -1, -1, 60, 80, false, false, false, {}, {"launcher"}, {"sights"}, "core");
    add_gunmod("sights_mount_pistol", "手枪瞄具底座", "pistol sights mount", "sights mount", 0, 0, 0, -1, -1, 60, 80, false, false, false, {}, {"pistol"}, {"sights"}, "core");
    ...
    add_gunmod("stock_mount", "现代化改装套件（枪托）", "replaceable stock kit", "stock mount", 0, 0, 0, -1, -1, 80, 50, false, false, false, {}, {"smg", "rifle", "pistol", "shotgun", "slingshot", "crossbow", "launcher"}, {"stock"}, "core");
    ...
    add_gunmod("underbarrel_mount", "管下底座", "bottom mount", "underbarrel mount", 0, 0, 0, -1, -1, 10, 8, false, false, false, {}, {"smg", "rifle", "pistol", "shotgun", "crossbow", "launcher", "bow"}, {"underbarrel"}, "core");
